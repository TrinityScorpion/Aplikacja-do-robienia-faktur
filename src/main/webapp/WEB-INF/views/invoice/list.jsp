...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item">
            <a class="nav-link" href="/recipient/home">
                      ...
                      <i class="fas fa-flag"></i>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <c:forEach items="${invoiceList}" var="invoice">
                                    <c:if test="${invoice.user.id==userId}">
                                        <tr>
                                            <td>${invoice.id}</td>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">User List - Admin Mode</h6>
                        </div>
                                    ...
                                    <c:forEach items="${userList}" var="user">
                                            <tr>
                                                ...
                                                <td><a href="/invoice/edit/${user.id}">Edit</a> <a
                                                        ...
                                                        href="/invoice/delete/${user.id}">View</a> <a
                                                        href="/invoice/view/${user.id}">Block User</a></td>
